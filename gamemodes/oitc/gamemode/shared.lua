...
GM.RoundPostLength = 3			// Seconds to show the 'x team won!' screen at the end of a round
...
function GM:CreateTeams()
	...
	-- Spetsnaz
	team.SetUp( TEAM_SPETSNAZ, "Spetsnaz", Color( 52, 152, 219 ), true )
	...
	-- Rangers
	team.SetUp( TEAM_RANGERS, "Rangers", Color( 231, 76, 60 ), true )
